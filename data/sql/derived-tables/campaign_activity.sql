...
CREATE MATERIALIZED VIEW public.posts AS
    (SELECT
	    ...
	    pd.post_class,
	    pd.campaign_id,
	    CASE WHEN pd.post_class ilike '%%text%%' and pd.campaign_id IN ('8167', '8168', '8309', '8292', '8226')
		      THEN null
		 WHEN pd.post_class ilike '%%social%%' and pd.campaign_id IN ('5438','7927','8025','8026','8103','8130','8158','8168', '8309', '8292', '8226', ) THEN null
