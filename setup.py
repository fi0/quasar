...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'ft_gambit_conversations_create = quasar.gambit_ft:create_gambit_conversations',
            'ft_gambit_conversations_refresh = quasar.gambit_ft:refresh_gambit_conversations',
            ...
            'ft_gambit_refresh_full = quasar.gambit_ft:refresh_gambit_full',
