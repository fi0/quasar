SELECT
    ...
    f.user_id
  FROM
    "quasar_prod_warehouse"."dbt_sena_ft_gambit_conversations_api"."messages_flattened" f
  WHERE
    f.direction <> 'inbound'
  ...
  UNION ALL
    (SELECT
      ...
      FROM
        "quasar_prod_warehouse"."dbt_sena_ft_gambit_conversations_api"."messages_flattened" g
      LEFT JOIN
